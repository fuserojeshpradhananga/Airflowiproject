...
output_dir = '/home/rojesh/airflow/csv/'
...
csv_file_path = ('/home/rojesh/airflow/csv/api_data.csv')
...
move_file_task = BashOperator(
    ...
    bash_command='mv /home/rojesh/airflow/csv/api_data.csv /tmp/csv/',
    dag = dag
)
...
spark_submit = BashOperator(
        ...
        bash_command="spark-submit /home/rojesh/airflow/dags/spark.py",
    )
